...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('bd_digital_service_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('bd_digital_service_category_id')->unsigned();
            $table->string('name');
            $table->string('slug');
            ...
            $table->foreign('bd_digital_service_category_id')
                ->references('id')->on('bd_digital_service_categories')
                ->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('bd_digital_service_items');
    }
};
