...
<head>
    ...
    <title>Register - Admin Dashboard - Bashona Trading Ltd</title>
    ...
    <link href="{{ asset('backEnd/assets/favicon/android-icon-192x192.png') }}" rel="icon" sizes="192x192" type="image/png"/>
            ...
            <div class="col-lg-8">
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-4 mb-0">
                        ...
                        <div class="card-body">
                            <h1>{{ __('Register') }}</h1>
                            <p class="text-medium-emphasis">{{ __('Register your account to go Admin Dashboard') }}</p>
                            <form method="POST" action="{{ route('register') }}">
                                @csrf

                                <div class="input-group mb-3">
                                    <span class="input-group-text"><svg class="icon"><use xlink:href="{{ asset('backEnd/vendors/@coreui/icons/svg/free.svg#cil-user') }}"></use></svg></span>
                                ...
                                <div class="input-group mb-4">
                                    <span class="input-group-text"><svg class="icon"><use xlink:href="{{ asset('backEnd/vendors/@coreui/icons/svg/brand.svg#cib-minutemailer') }}"></use></svg></span>
                                ...
                                <div class="input-group mb-4">
                                    <span class="input-group-text"><svg class="icon"><use xlink:href="{{ asset('backEnd/vendors/@coreui/icons/svg/free.svg#cil-lock-locked') }}"></use></svg></span>
