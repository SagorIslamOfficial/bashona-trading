...
@section('content')
    <div class="example">
        <h5>
            Click here to all Gallery Item
        ...
        <div class="tab-content rounded-bottom">
            <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-824">
                <!-- Contact form start -->
                <form action="{{ route('gallery-item.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control form-select @error('gallery_category_id') is-invalid @enderror" aria-label="Default select example" name="gallery_category_id" id="gallery_category_id">
                                ...
                                @foreach($getGalleryCategories as $GalleryCategory)
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" type="text" placeholder="Write your Gallery Item Name" />
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
