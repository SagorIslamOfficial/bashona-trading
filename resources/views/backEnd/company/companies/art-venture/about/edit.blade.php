            ...
            <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-824">
                ...
                <form method="POST" action="{{ route('art-venture-about.update', $editArtVentureAbout->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="text" placeholder="Update your Art Venture About Text" rows="5" class="form-control @error('text') is-invalid @enderror" id="text">{{ $editArtVentureAbout->text }}</textarea>
                            @error('text')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
