...
@section('title', 'Create - BD Digital About')

@section('content')
    <div class="example">
        <h5>
            Click here to all BD Digital About
        ...
        <div class="tab-content rounded-bottom">
            <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-824">
                <!-- Contact form start -->
                <form action="{{ route('bd-digital-about.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label" for="title">Title</label>
                        <div class="col-sm-8">
                            <input class="form-control @error('title') is-invalid @enderror" name="title" id="title" type="text" value="" placeholder="Write your BD Digital About Title !" />
                            @error('title')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="text" placeholder="Write your BD Digital About Text" rows="5" class="form-control @error('text') is-invalid @enderror" id="text"></textarea>
                            @error('text')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
