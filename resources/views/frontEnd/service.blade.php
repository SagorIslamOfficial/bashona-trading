...
@section('content')
    ...
    <div class="container py-2 mt-5">
        ...
        <ul id="portfolioPaginationFilter" class="nav nav-pills sort-source sort-source-style-3 justify-content-center" data-sort-id="portfolio" data-option-key="filter"  data-plugin-options="{'layoutMode': 'fitRows', 'filter': '.art-venture'}">
        ...
        <div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
            <div id="portfolioPaginationWrapper" class="row portfolio-list sort-destination" data-sort-id="portfolio" data-items-per-page="6">
...
{{--                <div class="col">--}}
{{--                    <div class="float-end">--}}
{{--                        @if ($companyArtVentureServiceItems == "art-venture" && $companyArtVentureServiceItems > 6){--}}
{{--                            {{ $companyArtVentureServiceItems->links() }}--}}

{{--                        @elseif (get_class($companyTnsServiceItems) > 8)--}}
{{--                            {{ $companyTnsServiceItems->links() }}--}}

{{--                        @elseif (get_class($companyBdDigitalServiceItems) > 8)--}}
{{--                            {{ $companyBdDigitalServiceItems->links() }}--}}

{{--                        @elseif (get_class($companyConnectToFlyServiceItems) > 8)--}}
{{--                            {{ $companyConnectToFlyServiceItems->links() }}--}}

{{--                        @else--}}
{{--                            <p>The variable is not equal to 1 or 2.</p>--}}
{{--                        @endif--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
