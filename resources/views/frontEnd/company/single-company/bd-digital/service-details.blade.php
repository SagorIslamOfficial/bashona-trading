    ...
    <div class="container py-4">
                                ...
                                <div class="owl-item active" style="width: 1116px; margin-right: 10px;">
                                    <div>
                                        <div class="img-thumbnail border-0 border-radius-0 p-0 d-block">
                                            <img src="{{ asset('storage/company/all-company/bd-digital/service/item/details/' . $image) }}" class="img-fluid border-radius-0" alt="{{ $singleCompanyBdDigitalServiceItem->name }}">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
        ...
        <div class="row pt-4 mt-2 mb-5">
            <div class="col-md-7 mb-4 mb-md-0">
                <h2 class="text-color-dark font-weight-normal text-5 mb-2"><strong class="font-weight-extra-bold">{{ $singleCompanyBdDigitalServiceItem->project_heading }}</strong></h2>
                <p class="text-justify">{{ $singleCompanyBdDigitalServiceItem->project_description }}</p>
            </div>
            <div class="col-md-5">
                <h2 class="text-color-dark font-weight-normal text-5 mb-2"><strong class="font-weight-extra-bold">{{ $singleCompanyBdDigitalServiceItem->project_details_heading }}</strong></h2>
                <ul class="list list-icons list-primary list-borders text-2">
                    ...
                    <li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">{{ $singleCompanyBdDigitalServiceItem->project_url }}: </strong> <a href="{{ $singleCompanyBdDigitalServiceItem->project_link }}" target="_blank" class="text-dark">{{ $singleCompanyBdDigitalServiceItem->project_url_content }}</a></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        @foreach($images as $image)
                            <div class="col-lg-4 col-md-4 col-sm-6" style="padding: 2px 2px !important;">
                                <a class="d-inline-block img-thumbnail img-thumbnail-no-borders img-thumbnail-hover-icon mb-1 me-1" href="{{ asset('storage/company/all-company/bd-digital/service/item/portfolio/' . $image) }}">
                                    <img style="border-radius: 1% !important; height: 220px" class="img-fluid" src="{{ asset('storage/company/all-company/bd-digital/service/item/portfolio/' . $image) }}" alt="{{ $singleCompanyBdDigitalServiceItem->name }}">
                                </a>
                            </div>
                        @endforeach
